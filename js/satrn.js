...
(function () {
     ...
     */
    // @ts-expect-error TS(2339): Property 'utils' does not exist on type '(config: ... Remove this comment to see the full error message
    satrn.utils.asString = function (obj) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'utils' does not exist on type '(config: ... Remove this comment to see the full error message
    satrn.utils.clone = function (obj) {
    ...
    satrn.FieldRef = function (docRef, fieldName, stringValue) {
        this.docRef = docRef;
    ...
    // @ts-expect-error TS(2339): Property 'FieldRef' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.FieldRef.fromString = function (s) {
        // @ts-expect-error TS(2339): Property 'FieldRef' does not exist on type '(confi... Remove this comment to see the full error message
     ...
     */
    // @ts-expect-error TS(2339): Property 'Set' does not exist on type '(config: an... Remove this comment to see the full error message
    satrn.Set.prototype.contains = function (object) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Set' does not exist on type '(config: an... Remove this comment to see the full error message
    satrn.Set.prototype.intersect = function (other) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Set' does not exist on type '(config: an... Remove this comment to see the full error message
    satrn.Set.prototype.union = function (other) {
        // @ts-expect-error TS(2339): Property 'Set' does not exist on type '(config: an... Remove this comment to see the full error message
        if (other === satrn.Set.complete) {
            // @ts-expect-error TS(2339): Property 'Set' does not exist on type '(config: an... Remove this comment to see the full error message
        ...
        // @ts-expect-error TS(2339): Property 'Set' does not exist on type '(config: an... Remove this comment to see the full error message
        return new satrn.Set(Object.keys(this.elements).concat(Object.keys(other.elements)));
    };
    /**
    ...
    satrn.idf = function (posting, documentCount) {
    ...
    satrn.Token = function (str, metadata) {
        this.str = str || "";
     ...
     */
    // @ts-expect-error TS(2339): Property 'Token' does not exist on type '(config: ... Remove this comment to see the full error message
    satrn.Token.prototype.update = function (fn) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Token' does not exist on type '(config: ... Remove this comment to see the full error message
    satrn.Token.prototype.clone = function (fn) {
        fn =
            fn ||
                function (s) {
                    return s;
    ...
    satrn.tokenizer = function (obj, metadata) {
        if (obj == null || obj == undefined) {
            return [];
        }
     ...
     */
    // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.Pipeline.registerFunction = function (fn, label) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.Pipeline.warnIfFunctionNotRegistered = function (fn) {
        var isRegistered = fn.label && fn.label in this.registeredFunctions;
        if (!isRegistered) {
            // @ts-expect-error TS(2339): Property 'utils' does not exist on type '(config: ... Remove this comment to see the full error message
            satrn.utils.warn("Function is not registered with pipeline. This may cause problems when serialising the index.\n", fn);
        }
    };
    /**
     ...
     */
    // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.Pipeline.load = function (serialised) {
        // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
     ...
     */
    // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.Pipeline.prototype.after = function (existingFn, newFn) {
        // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
     ...
     */
    // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.Pipeline.prototype.before = function (existingFn, newFn) {
        // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
        satrn.Pipeline.warnIfFunctionNotRegistered(newFn);
        var pos = this._stack.indexOf(existingFn);
        if (pos == -1) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.Pipeline.prototype.remove = function (fn) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.Pipeline.prototype.run = function (tokens) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Pipeline' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.Pipeline.prototype.runString = function (str, metadata) {
        // @ts-expect-error TS(2339): Property 'Token' does not exist on type '(config: ... Remove this comment to see the full error message
    ...
    satrn.Vector = function (elements) {
        this._magnitude = 0;
     ...
     */
    // @ts-expect-error TS(2339): Property 'Vector' does not exist on type '(config:... Remove this comment to see the full error message
    satrn.Vector.prototype.positionForIndex = function (index) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Vector' does not exist on type '(config:... Remove this comment to see the full error message
    satrn.Vector.prototype.insert = function (insertIdx, val) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Vector' does not exist on type '(config:... Remove this comment to see the full error message
    satrn.Vector.prototype.upsert = function (insertIdx, val, fn) {
        this._magnitude = 0;
     ...
     */
    // @ts-expect-error TS(2339): Property 'Vector' does not exist on type '(config:... Remove this comment to see the full error message
    satrn.Vector.prototype.dot = function (otherVector) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Vector' does not exist on type '(config:... Remove this comment to see the full error message
    satrn.Vector.prototype.similarity = function (otherVector) {
    ...
    satrn.generateStopWordFilter = function (stopWords) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.TokenSet.fromArray = function (arr) {
        // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
     ...
     */
    // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.TokenSet.fromClause = function (clause) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.TokenSet.fromFuzzyString = function (str, editDistance) {
        // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
     ...
     */
    // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.TokenSet.fromString = function (str) {
        // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
        var node = new satrn.TokenSet(), root = node;
        /*
     ...
     */
    // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.TokenSet.prototype.intersect = function (b) {
        // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
        var output = new satrn.TokenSet(), frame = undefined;
        var stack = [
            {
                qNode: b,
                output: output,
    ...
    // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.TokenSet.Builder.prototype.insert = function (word) {
        ...
        for (var i = commonPrefix; i < word.length; i++) {
            // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
            var nextNode = new satrn.TokenSet(), char = word[i];
    ...
    // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
    satrn.TokenSet.Builder.prototype.minimize = function (downTo) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Index' does not exist on type '(config: ... Remove this comment to see the full error message
    satrn.Index.prototype.search = function (queryString) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Index' does not exist on type '(config: ... Remove this comment to see the full error message
    satrn.Index.prototype.query = function (fn) {
        ...
        var query = new satrn.Query(this.fields), matchingFields = Object.create(null), queryVectors = Object.create(null), termFieldCache = Object.create(null), requiredMatches = Object.create(null), prohibitedMatches = Object.create(null);
        /*
        ...
        for (var i = 0; i < query.clauses.length; i++) {
             ...
             */
            var clause = query.clauses[i], terms = null, 
            // @ts-expect-error TS(2339): Property 'Set' does not exist on type '(config: an... Remove this comment to see the full error message
            ...
            for (var m = 0; m < terms.length; m++) {
                 ...
                 */
                // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
                var termTokenSet = satrn.TokenSet.fromClause(clause), expandedTerms = this.tokenSet.intersect(termTokenSet).toArray();
                /*
                ...
                for (var j = 0; j < expandedTerms.length; j++) {
                    ...
                    for (var k = 0; k < clause.fields.length; k++) {
                         ...
                         * term from above.
                         */
                        var field = clause.fields[k], fieldPosting = posting[field], matchingDocumentRefs = Object.keys(fieldPosting), termField = expandedTerm + "/" + field, 
                        // @ts-expect-error TS(2339): Property 'Set' does not exist on type '(config: an... Remove this comment to see the full error message
                        ...
                        for (var l = 0; l < matchingDocumentRefs.length; l++) {
                            ...
                            // @ts-expect-error TS(2339): Property 'FieldRef' does not exist on type '(confi... Remove this comment to see the full error message
                            matchingFieldRef = new satrn.FieldRef(matchingDocumentRef, field), metadata = fieldPosting[matchingDocumentRef], fieldMatch;
                            if ((fieldMatch = matchingFields[matchingFieldRef]) === undefined) {
                                ...
                                matchingFields[matchingFieldRef] = new satrn.MatchData(expandedTerm, field, metadata);
                            }
                            else {
        ...
        for (var i = 0; i < matchingFieldRefs.length; i++) {
             ...
             */
            // @ts-expect-error TS(2339): Property 'FieldRef' does not exist on type '(confi... Remove this comment to see the full error message
            var fieldRef = satrn.FieldRef.fromString(matchingFieldRefs[i]), docRef = fieldRef.docRef;
     ...
     */
    // @ts-expect-error TS(2339): Property 'Index' does not exist on type '(config: ... Remove this comment to see the full error message
    satrn.Index.load = function (serializedIndex) {
        var attrs = {}, fieldVectors = {}, serializedVectors = serializedIndex.fieldVectors, invertedIndex = Object.create(null), serializedInvertedIndex = serializedIndex.invertedIndex, 
        // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
        ...
        if (serializedIndex.version != satrn.version) {
            // @ts-expect-error TS(2339): Property 'utils' does not exist on type '(config: ... Remove this comment to see the full error message
            satrn.utils.warn("Version mismatch when loading serialised index. Current version of satrn '" +
                // @ts-expect-error TS(2339): Property 'version' does not exist on type '(config... Remove this comment to see the full error message
                satrn.version +
        ...
        // @ts-expect-error TS(2339): Property 'fieldVectors' does not exist on type '{}... Remove this comment to see the full error message
        attrs.fieldVectors = fieldVectors;
        // @ts-expect-error TS(2339): Property 'invertedIndex' does not exist on type '{... Remove this comment to see the full error message
        attrs.invertedIndex = invertedIndex;
        // @ts-expect-error TS(2339): Property 'tokenSet' does not exist on type '{}'.
        attrs.tokenSet = tokenSetBuilder.root;
        // @ts-expect-error TS(2339): Property 'pipeline' does not exist on type '{}'.
     ...
     */
    // @ts-expect-error TS(2339): Property 'Builder' does not exist on type '(config... Remove this comment to see the full error message
    satrn.Builder.prototype.ref = function (ref) {
        this._ref = ref;
    };
    /**
     ...
     */
    // @ts-expect-error TS(2339): Property 'Builder' does not exist on type '(config... Remove this comment to see the full error message
    satrn.Builder.prototype.field = function (fieldName, attributes) {
        if (/\//.test(fieldName)) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Builder' does not exist on type '(config... Remove this comment to see the full error message
    satrn.Builder.prototype.b = function (number) {
        if (number < 0) {
            this._b = 0;
        }
        else if (number > 1) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Builder' does not exist on type '(config... Remove this comment to see the full error message
    satrn.Builder.prototype.k1 = function (number) {
        this._k1 = number;
    };
    /**
     ...
     */
    // @ts-expect-error TS(2339): Property 'Builder' does not exist on type '(config... Remove this comment to see the full error message
    satrn.Builder.prototype.add = function (doc, attributes) {
        ...
        for (var i = 0; i < fields.length; i++) {
            ...
            // @ts-expect-error TS(2339): Property 'FieldRef' does not exist on type '(confi... Remove this comment to see the full error message
            fieldRef = new satrn.FieldRef(docRef, fieldName), fieldTerms = Object.create(null);
    ...
    satrn.Builder.prototype.calculateAverageFieldLengths = function () {
        ...
        for (var i = 0; i < numberOfFields; i++) {
            // @ts-expect-error TS(2339): Property 'FieldRef' does not exist on type '(confi... Remove this comment to see the full error message
            var fieldRef = satrn.FieldRef.fromString(fieldRefs[i]), field = fieldRef.fieldName;
    ...
    satrn.Builder.prototype.createFieldVectors = function () {
        ...
        for (var i = 0; i < fieldRefsLength; i++) {
            // @ts-expect-error TS(2339): Property 'FieldRef' does not exist on type '(confi... Remove this comment to see the full error message
            var fieldRef = satrn.FieldRef.fromString(fieldRefs[i]), fieldName = fieldRef.fieldName, fieldLength = this.fieldLengths[fieldRef], 
            // @ts-expect-error TS(2339): Property 'Vector' does not exist on type '(config:... Remove this comment to see the full error message
            fieldVector = new satrn.Vector(), termFrequencies = this.fieldTermFrequencies[fieldRef], terms = Object.keys(termFrequencies), termsLength = terms.length;
    ...
    satrn.Builder.prototype.createTokenSet = function () {
        // @ts-expect-error TS(2339): Property 'TokenSet' does not exist on type '(confi... Remove this comment to see the full error message
        this.tokenSet = satrn.TokenSet.fromArray(Object.keys(this.invertedIndex).sort());
    };
    /**
     ...
     */
    // @ts-expect-error TS(2339): Property 'Builder' does not exist on type '(config... Remove this comment to see the full error message
    satrn.Builder.prototype.use = function (fn) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'MatchData' does not exist on type '(conf... Remove this comment to see the full error message
    satrn.MatchData = function (term, field, metadata) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'MatchData' does not exist on type '(conf... Remove this comment to see the full error message
    satrn.MatchData.prototype.combine = function (otherMatchData) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'MatchData' does not exist on type '(conf... Remove this comment to see the full error message
    satrn.MatchData.prototype.add = function (term, field, metadata) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Query' does not exist on type '(config: ... Remove this comment to see the full error message
    satrn.Query = function (allFields) {
        this.clauses = [];
     ...
     */
    // @ts-expect-error TS(2339): Property 'Query' does not exist on type '(config: ... Remove this comment to see the full error message
    satrn.Query.prototype.clause = function (clause) {
        if (!("fields" in clause)) {
     ...
     */
    // @ts-expect-error TS(2339): Property 'Query' does not exist on type '(config: ... Remove this comment to see the full error message
    satrn.Query.prototype.term = function (term, options) {
    ...
    satrn.QueryParseError = function (message, start, end) {
    ...
    // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
    satrn.QueryLexer.prototype.emit = function (type) {
        this.lexemes.push({
            type: type,
    ...
    // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
    satrn.QueryLexer.lexField = function (lexer) {
        lexer.backup();
        // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
    ...
    // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
    satrn.QueryLexer.lexTerm = function (lexer) {
        if (lexer.width() > 1) {
            lexer.backup();
            // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
    ...
    // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
    satrn.QueryLexer.lexEditDistance = function (lexer) {
        lexer.ignore();
    ...
    // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
    satrn.QueryLexer.lexBoost = function (lexer) {
        lexer.ignore();
        lexer.acceptDigitRun();
        // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
    ...
    // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
    satrn.QueryLexer.lexEOS = function (lexer) {
        if (lexer.width() > 0) {
            // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
            lexer.emit(satrn.QueryLexer.TERM);
        }
    ...
    // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
    satrn.QueryLexer.lexText = function (lexer) {
        while (true) {
            var char = lexer.next();
            // @ts-expect-error TS(2339): Property 'QueryLexer' does not exist on type '(con... Remove this comment to see the full error message
            if (char == satrn.QueryLexer.EOS) {
    ...
    // @ts-expect-error TS(2339): Property 'QueryParser' does not exist on type '(co... Remove this comment to see the full error message
    satrn.QueryParser = function (str, query) {
    ...
    // @ts-expect-error TS(2339): Property 'QueryParser' does not exist on type '(co... Remove this comment to see the full error message
    satrn.QueryParser.parseClause = function (parser) {
    ...
    // @ts-expect-error TS(2339): Property 'QueryParser' does not exist on type '(co... Remove this comment to see the full error message
    satrn.QueryParser.parsePresence = function (parser) {
        ...
        switch (nextLexeme.type) {
            ...
            default:
                ...
                // @ts-expect-error TS(2339): Property 'QueryParseError' does not exist on type ... Remove this comment to see the full error message
                throw new satrn.QueryParseError(errorMessage, nextLexeme.start, nextLexeme.end);
        }
    };
    // @ts-expect-error TS(2339): Property 'QueryParser' does not exist on type '(co... Remove this comment to see the full error message
    satrn.QueryParser.parseField = function (parser) {
        var lexeme = parser.consumeLexeme();
        if (lexeme == undefined) {
            return;
        }
        if (parser.query.allFields.indexOf(lexeme.str) == -1) {
            var possibleFields = parser.query.allFields
                ...
                .join(", "), errorMessage = "unrecognised field '" +
                lexeme.str +
                "', possible fields: " +
                possibleFields;
            // @ts-expect-error TS(2339): Property 'QueryParseError' does not exist on type ... Remove this comment to see the full error message
    ...
    // @ts-expect-error TS(2339): Property 'QueryParser' does not exist on type '(co... Remove this comment to see the full error message
    satrn.QueryParser.parseTerm = function (parser) {
        var lexeme = parser.consumeLexeme();
        if (lexeme == undefined) {
            return;
        }
    ...
    // @ts-expect-error TS(2339): Property 'QueryParser' does not exist on type '(co... Remove this comment to see the full error message
    satrn.QueryParser.parseEditDistance = function (parser) {
        var lexeme = parser.consumeLexeme();
        if (lexeme == undefined) {
            return;
        }
    ...
    // @ts-expect-error TS(2339): Property 'QueryParser' does not exist on type '(co... Remove this comment to see the full error message
    satrn.QueryParser.parseBoost = function (parser) {
        var lexeme = parser.consumeLexeme();
        if (lexeme == undefined) {
            return;
        }
