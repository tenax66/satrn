...
(function (root, factory) {
    ...
    return function (satrn) {
        ...
        satrn.ja = function () {
            this.pipeline.reset();
            this.pipeline.add(satrn.ja.trimmer, satrn.ja.stopWordFilter, satrn.ja.stemmer);
        ...
        satrn.ja.tokenizer = function (obj) {
            var i;
            var str;
            var len;
            var segs;
                ...
                if (char.match(/\s/) || sliceEnd == len) {
                    if (sliceLength > 0) {
                        ...
                        for (i = 0; i < segs.length; i++) {
                            if (isLunr2) {
                                tokens.push(new satrn.Token(segs[i], {
        ...
        satrn.ja.trimmer = satrn.trimmerSupport.generateTrimmer(satrn.ja.wordCharacters);
        ...
        satrn.ja.stopWordFilter = satrn.generateStopWordFilter("これ それ あれ この その あの ここ そこ あそこ こちら どこ だれ なに なん 何 私 貴方 貴方方 我々 私達 あの人 あのかた 彼女 彼 です あります おります います は が の に を で え から まで より も どの と し それで しかし".split(" "));
        satrn.Pipeline.registerFunction(satrn.ja.stopWordFilter, "stopWordFilter-ja");
        ...
        satrn.Pipeline.registerFunction(satrn.jp.stopWordFilter, "stopWordFilter-jp");
    };
});
